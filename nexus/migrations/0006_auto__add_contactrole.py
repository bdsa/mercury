...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'nexus.contact': {
            ...
            'roles': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['nexus.Role']", 'through': u"orm['nexus.ContactRole']", 'symmetrical': 'False'}),
        ...
        u'nexus.role': {
            ...
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['nexus.Contact']", 'through': u"orm['nexus.ContactRole']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']"}),
