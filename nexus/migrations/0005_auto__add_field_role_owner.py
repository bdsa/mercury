...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.owner'
        db.add_column(u'nexus_role', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.owner'
        db.delete_column(u'nexus_role', 'owner_id')
    ...
    models = {
        ...
        u'nexus.role': {
            ...
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['nexus.Contact']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']"}),
