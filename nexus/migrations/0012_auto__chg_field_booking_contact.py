...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nexus_booking', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nexus.Contact'], null=True))

    def backwards(self, orm):

        # Changing field 'Booking.contact'
        db.alter_column(u'nexus_booking', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['nexus.Contact']))
