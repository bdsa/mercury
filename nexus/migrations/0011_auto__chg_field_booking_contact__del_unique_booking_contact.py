...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Booking', fields ['contact']
        # db.delete_unique(u'nexus_booking', ['contact_id'])

        # Changing field 'Booking.contact'
        db.alter_column(u'nexus_booking', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nexus.Contact']))

    def backwards(self, orm):

        # Changing field 'Booking.contact'
        db.alter_column(u'nexus_booking', 'contact_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['nexus.Contact'], unique=True))
        # Adding unique constraint on 'Booking', fields ['contact']
        db.create_unique(u'nexus_booking', ['contact_id'])
    ...
    models = {
        ...
        u'nexus.booking': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nexus.Contact']"}),
